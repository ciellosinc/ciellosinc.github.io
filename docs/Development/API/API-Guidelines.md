...
- [Microsoft REST API Guidelines](#microsoft-rest-api-guidelines-1)
  ...
  - [12 Versioning](#12-versioning)
    - [12.1 Versioning formats](#121-versioning-formats)
      - [12.1.1 Group versioning](#1211-group-versioning)
        - [12.1.1.1 Examples of group versioning](#12111-examples-of-group-versioning)
  ...
  - [13 Long running operations](#13-long-running-operations)
    ...
    - [13.2 Stepwise long running operations](#132-stepwise-long-running-operations)
      ...
      - [13.2.5    Operation resource](#1325----operation-resource)
        - [13.2.5.1 Percent complete](#13251-percent-complete)
        - [13.2.5.2 Target resource location](#13252-target-resource-location)
      - [13.2.6 Operation tombstones](#1326-operation-tombstones)
      - [13.2.7 The typical flow, polling](#1327-the-typical-flow-polling)
        - [13.2.7.1 Example of the typical flow, polling](#13271-example-of-the-typical-flow-polling)
      - [13.2.8 The typical flow, push notifications](#1328-the-typical-flow-push-notifications)
        - [13.2.8.1 Example of the typical flow, push notifications existing subscription](#13281-example-of-the-typical-flow-push-notifications-existing-subscription)
  ...
  - [14 Push notifications via webhooks](#14-push-notifications-via-webhooks)
    ...
    - [14.6 Receiving notifications](#146-receiving-notifications)
      - [14.6.1 Notification payload](#1461-notification-payload)
    - [14.7 Managing subscriptions programmatically](#147-managing-subscriptions-programmatically)
      - [14.7.1 Creating subscriptions](#1471-creating-subscriptions)
      - [14.7.2 Updating subscriptions](#1472-updating-subscriptions)
      - [14.7.3 Deleting subscriptions](#1473-deleting-subscriptions)
      - [14.7.4 Enumerating subscriptions](#1474-enumerating-subscriptions)
  ...
  - [15 Unsupported requests](#15-unsupported-requests)
    ...
    - [15.2 Feature allow list](#152-feature-allow-list)
      - [15.2.1 Error response](#1521-error-response)
  - [16 Appendix](#16-appendix)
    - [16.1 Sequence diagram notes](#161-sequence-diagram-notes)
      - [16.1.1 Push notifications, per user flow](#1611-push-notifications-per-user-flow)
      - [16.1.2 Push notifications, firehose flow](#1612-push-notifications-firehose-flow)
